...
import com.saralpe.app.databinding.HomeInvestTradeStocksItemDesignBinding
...
class InvestTradeStocksListAdapter(private val context: Context, private var itemsList: ArrayList<Pair<Int,String>>) :
    RecyclerView.Adapter<InvestTradeStocksListAdapter.ItemViewHolder>() {
    ...
    open class ItemViewHolder(
        private val binding: HomeInvestTradeStocksItemDesignBinding,
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val layoutBinding =
            HomeInvestTradeStocksItemDesignBinding.inflate(LayoutInflater.from(parent.context), parent, false)
