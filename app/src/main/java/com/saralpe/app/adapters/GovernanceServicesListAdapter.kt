...
class GovernanceServicesListAdapter(private val context: Context, private var itemsList: ArrayList<Pair<Int,String>>) :
    RecyclerView.Adapter<GovernanceServicesListAdapter.ItemViewHolder>() {
    ...
    open class ItemViewHolder(
        private val binding: HomeEgovernanceServicesItemDesignBinding,
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val layoutBinding =
            HomeEgovernanceServicesItemDesignBinding.inflate(LayoutInflater.from(parent.context), parent, false)
