...
class RechargeBillPaymentListAdapter(private val context: Context, private var itemsList: ArrayList<Pair<Int,String>>) :
    RecyclerView.Adapter<RechargeBillPaymentListAdapter.ItemViewHolder>() {
    ...
    open class ItemViewHolder(
        private val binding: HomeRechargeBillPaymentItemDesignBinding,
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val layoutBinding =
            HomeRechargeBillPaymentItemDesignBinding.inflate(LayoutInflater.from(parent.context), parent, false)
